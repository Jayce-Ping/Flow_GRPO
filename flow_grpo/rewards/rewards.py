...
def multi_score(device, score_dict) -> Callable[[List[Image.Image], List[str], List[dict], bool, bool], Tuple[dict[str, List[float]], dict]]:
    score_functions = {
    ...
    def _fn(images : List[Image.Image], prompts : List[str], metadata: List[dict], ref_images=None, only_strict=True) -> Tuple[np.ndarray, dict]:
        total_scores = []
        score_details = {}
