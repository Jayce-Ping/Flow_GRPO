...
def subfig_clip_dreamsim_flux():
    ...
    assert unique_sample_num_per_epoch == config.sample.unique_sample_num_per_epoch and num_images_per_prompt == config.sample.num_images_per_prompt, \
        f""" Current setting:
            config.sample.unique_sample_num_per_epoch={config.sample.unique_sample_num_per_epoch}
            config.sample.num_images_per_prompt={config.sample.num_images_per_prompt}
            requires total sample number per epoch to be multiplies of {config.sample.unique_sample_num_per_epoch}*{config.sample.num_images_per_prompt}={config.sample.unique_sample_num_per_epoch*config.sample.num_images_per_prompt},
            ...
            or config.sample.num_images_per_prompt to be {num_images_per_prompt}.
        """
